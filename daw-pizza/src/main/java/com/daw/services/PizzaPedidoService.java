	 ...
	 @Autowired
		...
		public PizzaPedido update(int idPizzaPedido, PizzaPedido pizzaPedido) {
			if(idPizzaPedido != pizzaPedido.getId()) {
				throw new PedidoPizzaNotFoundExceptions("El ID del path y del body no coinciden. ");
			}
		...
		public List<PedidoPizzaOutPutDTO> findByIdPedido(int idPedido){
			return PizzaPedidoMapper.toDtos(this.pizzaPedidoRepository.findByIdPedido(idPedido));
		}
		
		public PedidoPizzaOutPutDTO findDTOById(int idPizzaPedido) {
			if(!this.pizzaPedidoRepository.existsById(idPizzaPedido)) {
				throw new PedidoPizzaNotFoundExceptions("El ID indicado no existe. ");
			}
		...
		public PedidoPizzaOutPutDTO createDTO(PizzaPedidoInputDTO dto) {	
		...
		public PedidoPizzaOutPutDTO updateDTO(int idPizzaPedido, PizzaPedidoInputDTO dto) {
